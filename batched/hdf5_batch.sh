...
python NucleiTracking/batched/hdf5_extraction.py -i "/mnt/ceph/users/hoatman/lightsheet_20241030/raw" -o "/mnt/ceph/users/hoatman/lightsheet_20241030/raw_image" --nprocs 16 --level INFO
