...
python NucleiTracking/batched/multiprocess_cellpose_dir.py -i "ceph/lightsheet_20241104/raw_image" --model cyto3 --diam 17 -t 99.999 --do_3d --use_gpu --axes zyx --batch_size 128 --nprocs 4 --level WARN