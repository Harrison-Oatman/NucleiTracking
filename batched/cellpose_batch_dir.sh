...
python NucleiTracking/batched/multiprocess_cellpose_dir.py -i "ceph/lightsheet2" --model nuclei --diam 9 -t 99.5 --do_3d --use_gpu --axes zyx --batch_size 64 --nprocs 4