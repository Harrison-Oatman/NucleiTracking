...
python NucleiTracking/batched/multiprocess_cellpose_dir.py -i "ceph/lightsheet_20241104/raw_image/downscaled/recon"  --model Crop007 --diam 17 -t 99.5 --use_gpu --do_3d --axes zyx --batch_size 128 --nprocs 4 --level INFO