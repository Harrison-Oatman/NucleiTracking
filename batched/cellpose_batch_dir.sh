...
python NucleiTracking/batched/multiprocess_cellpose_dir.py -i "ceph/lightsheet_20241104/raw_image/downscaled" -o "ceph/lightsheet_20241104/raw_image/downscaled" --model cyto3 --diam 17 -t 99.999 --use_gpu --axes tyx --batch_size 128 --nprocs 4 --level INFO