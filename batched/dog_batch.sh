...
python NucleiTracking/batched/dog.py -i "/mnt/home/hoatman/ceph/lightsheet_20250206/raw_image/downscaled/recon/" --nprocs 32 --min_distance 3 --threshold_abs 100 --sigma_low 2 --sigma_high 7 --level INFO
