...
python NucleiTracking/batched/dummy.py -i "/mnt/ceph/users/hoatman/lightsheet_20241030/raw" -o "/mnt/ceph/users/hoatman/lightsheet_20241030/Raw image" --nprocs 4 --level INFO
