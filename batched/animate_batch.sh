...
python NucleiTracking/batched/animate_dir.py -i "/mnt/home/hoatman/ceph/lightsheet_20241104/raw_image/downscaled/recon/" --angle_init 0 --angle_final 100 --nprocs 32 --level INFO
