...
python NucleiTracking/batched/multiprocess_cellpose.py -i "ceph/3d_microscopy/tll_Embryo002b_bgs.tif" --model 3d08 --diam 17 --stitch_threshold 0.6 --use_gpu --axes tzyx --batch_size 64 --nprocs 4 --level WARN --channels 1 0